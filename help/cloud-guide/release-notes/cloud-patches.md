...
- ![fix icon](../../assets/fix.svg) **Security improvements**—Applied the security fixes referenced in [Adobe Commerce Security Update APSB26-92](https://helpx.adobe.com/security/products/magento/apsb26-92.html).<!--MCLOUD-15035 -->
...
- ![fix icon](../../assets/fix.svg) **Enhanced Symfony L2 cache performance and reliability**—Optimized cache tag storage for symfony_l2, improved cache invalidation, and enabled Redis/Valkey compression (compress_data) by default to reduce memory consumption and network traffic.<!-- ACP2E-5132 -->

## v1.1.15

Release date: July 14, 2026

- ![fix icon](../../assets/fix.svg) **Security improvements**—Applied the security fixes referenced in [Adobe Commerce Security Update APSB26-73](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-37421).<!--MCLOUD-15066 -->
...
- ![new icon](../../assets/new.svg) **Updated patch for Commerce 2.4.4 to 2.4.8**—This patch is an updated patch for [CVE-2025-24434](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27148), which was released in 1.1.7<!-- MCLOUD-13619 -->

## v1.1.6

Release date: April 24, 2025

- ![new icon](../../assets/new.svg) **Updated patch for Commerce 2.4.4 to 2.4.7**—This update is an updated patch for [CVE-2025-24434](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27149), which was released in 1.1.4<!-- MCLOUD-13240 -->
...
- ![new icon](../../assets/new.svg) **Added patch for Commerce 2.4.4 to 2.4.7**—This update patches [CVE-2025-24434](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27149).<!-- MCLOUD-13240     - -->
...
- ![fix icon](../../assets/fix.svg) **Added patch for Commerce 2.4.4 to 2.4.7**—This update fixes a critical [CVE-2024-45115](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27151) vulnerability for Adobe Commerce when using the B2B module.<!-- MCLOUD-12980 - -->
...
- **Cache improvements**—This patch enhances layout cache efficiency, reducing memory usage, for Adobe Commerce versions 2.4.4 and later.<!-- MCLOUD-11514 -->
...
See [Admin can't create order/reorder when Braintree payment enabled](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27169).
...
- **PHP error**—Fixed a `PHP error 'Undefined variable: errorMessage' ...` error. This error occurred while trying to apply a patch.<!-- ACP2E-138 -->
...
- **Deprecated patches become visible**—Fixed a cloud-patches issue in which deprecated patches become visible in the patches table after applying a replacement patch that contains the entire contents of the deprecated patch. This happens if you applied a patch that combined several other patches.<!--MC-40626-->
...
- **PayPal Express Checkout**—This patch resolves an issue where the shipping address country region is manually entered instead of selected from the drop-down menu. See the complete patch description on the patch download page.
...
All Magento Open Source 2.x patches from the software downloads page are included in the magento/magento-cloud-patches v1.0.1 release. To avoid conflicts, remove any patches you copied into your project previously.

This release includes the following patches and critical fixes:

- **Fix cron deadlocks and improve cron locking**—

   - Fixes an issue with some cron jobs not running due to an incorrect status value in the `cron_schedule` table. Now, the Adobe Commerce lock framework is used to check and update cron job status instead of using the `cron_schedule` table. Cron jobs that have ended with an error status are retried during the next cron run instead of waiting 24 hours.

   - To avoid deadlock during updates to the data in the `cron_schedule` table, add a _retry_ operation.
...
- **Page Builder security patches for 2.3.1.x and 2.3.2.x releases**—Fixes a Page Builder preview issue that allows unauthenticated users to trigger arbitrary code execution (RCE) and global information leaks. This issue can occur when using unsupported versions of Page Builder with Adobe Commerce versions 2.3.1 and 2.3.2.<!--MAGECLOUD-4649-->
