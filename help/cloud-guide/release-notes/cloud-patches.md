...
- ![fix icon](../../assets/fix.svg) **Security improvements**-Applied the security fixes referenced in APSB26-92.<!--MCLOUD-15035 -->
...
- ![fix icon](../../assets/fix.svg) **Security improvements**-Implemented security fixes related to APSB26-73.<!--MCLOUD-15066 -->
