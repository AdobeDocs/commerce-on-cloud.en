...
- ![fix icon](../../assets/fix.svg) **Patch** – Fix for the [Checkout fails when JS minification and bundling are enabled](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27997)) issue described in the *Commerce Knowledgebase" (tickets AC-15867 & ACSD-68617).
