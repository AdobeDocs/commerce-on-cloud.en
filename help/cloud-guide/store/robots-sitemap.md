...
To activate `robots.txt` customizations in Production, you must enable indexing by search engines for `<environment-name>`** option in your project settings on the Cloud Console:

- Legacy Cloud Console, i.e., the URL follows the pattern ``https://<region-id>.magento.cloud/projects/<project_id>``
...
- Adobe Cloud Console, i.e., the URL follows the pattern ``https://console.adobecommerce.com/<username>/<project_id>``
