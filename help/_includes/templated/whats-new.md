...
<table style="table-layout:auto;">
  ...
  <tbody>
    <tr>
      <td><p>Clarified in <a href="https://experienceleague.adobe.com/en/docs/commerce-on-cloud/user-guide/release-notes/cloud-patches">Cloud Patches for Commerce</a> and <a href="https://experienceleague.adobe.com/en/docs/commerce-on-cloud/user-guide/release-notes/cloud-tools-suite">Release notes for Commerce Cloud Tools Suite</a> that, starting with version 1.1.15, customers must download the Cloud Patches for Commerce package through Composer from <code>repo.magento.com</code> rather than from GitHub, and that an Adobe Commerce on cloud infrastructure entitlement is required.</p>
</td>
      <td>
        Feedback, technical
      </td>
...
<table style="table-layout:auto;">
  ...
  <tbody>
    <tr>
      <td><p>The new <a href="https://experienceleague.adobe.com/en/docs/commerce-on-cloud/user-guide/monitor/new-relic/traffic-insights/overview">Traffic Insights</a> app helps users visualize their CDN traffic.</p>
</td>
      <td>
