...
>[!NOTE] All scheduled maintenance windows must be provided in UTC format to ensure clarity and consistency across all communications. Service upgrades cannot be scheduled in the Staging environment; in most cases, upgrades in Staging are performed on the same day as the request.
