...
1. **Redeploy the environment** after Adobe completes the service upgrade so the change takes effect, even if the Adobe Commerce application version does not change.
